...
class PaletMetadata:
    ...
    class Enrichment():
        ...
        defined_columns = {
            ...
            'race_ethncty_flag': _buildRaceEthnicityColumn,
            'SUBMTG_STATE_CD': _mergeStateEnrollments,
            'race_ethncty_exp_flag': _buildRaceEthnicityExpColumn,
            'ethncty_cd': _buildEthnicityColumn,
            'enrl_type_flag': _buildEnrollmentType,
            'elgblty_grp_cd': _buildEligibilityType,
            'incm_cd': _buildIncomeColumn
            }
