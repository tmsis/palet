"""
The CoverageType module is a critical component of the the by group :meth:`~Paletable.Paletable.byCoverageType` in :class:`Paletable`. This module only contains one class, CoverageType.
"""
